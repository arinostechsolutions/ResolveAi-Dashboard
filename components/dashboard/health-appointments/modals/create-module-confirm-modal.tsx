    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="rounded-lg border border-slate-700 bg-slate-800 p-6 max-w-md w-full">
        ...
        <p className="text-slate-300 mb-4">
          Você está prestes a criar a estrutura do módulo de saúde no menu do aplicativo mobile.
        </p>
        <p className="text-slate-400 text-sm mb-6">
          ...
          Você precisará configurar o item do menu e, após cadastrar hospitais com especialidades ou exames, poderá habilitar o módulo através da toggle em "Gerenciar Saúde".
        </p>
